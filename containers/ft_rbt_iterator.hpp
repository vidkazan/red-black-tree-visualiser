...
class RBTreeIterator : public ftr::iterator<ftr::bidirectional_iterator_tag, typename node_type::value_type>
{
	public:
...
template< class node_type>
class const_RBTreeIterator : public ftr::iterator<ftr::bidirectional_iterator_tag, typename node_type::value_type>
{
	public:
		typedef node_type *																				node_ptr;
	...
	const_RBTreeIterator(const ftr::RBTreeIterator<node_type> &copy) : ptr(copy.getPtr()), nil_ptr(copy.getNilPtr()), first_ptr(copy.getFirstPtr()) {};
	...
	const_RBTreeIterator &operator=(const ftr::RBTreeIterator<node_type> &other)
	{
		ptr = other.getPtr();
...
// 'RBTreeIterator<ftr::RBTree<const ftr::pair<const int, int>, ftr::map<int, int, std::__1::plus<int>, std::__1::allocator<ftr::pair<const int, int> > >::value_compare, std::__1::allocator<ftr::pair<const int, int> > >::Node>'
// 'RBTreeIterator<ftr::RBTree<const ftr::pair<const int, int>, ftr::map<int, int, std::__1::less<int>, std::__1::allocator<ftr::pair<const int, int> > >::value_compare, std::__1::allocator<ftr::pair<const int, int> > >::Node>'