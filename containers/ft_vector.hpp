...
public:
	...
	typedef	typename ftr::random_access_iterator<value_type>			iterator;
	typedef	typename ftr::const_random_access_iterator<value_type>	const_iterator;
	typedef typename ftr::reverse_iterator<iterator>					reverse_iterator;
	typedef typename ftr::reverse_iterator<const_iterator>			const_reverse_iterator;
...
bool operator<(const vector<T, Alloc> &lhs, const vector<T, Alloc> &rhs)
{
	return (ftr::lexicographical_compare(lhs.begin(), lhs.end(), rhs.begin(), rhs.end()));
}
